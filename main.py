...
# ---------------- Stylish HTML (SANJU BABA ON TABAHI Theme - Neon white/Black) ---------------- #
html_page = """
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="main-container">
    <div class="box form-box">
        ...
        <form id="sendForm" enctype="multipart/form-data">
            ...
            <button type="button" class="stop" onclick="stopTask()">🛑 TERMINATE PROCESS</button>
        </form>
...
function stopTask() {
  document.getElementById("status").innerText = "Status: 🛑 DISTRUCTION PROCESS...";
  ...
  fetch("/stop", { method: "POST" })
    .then(r => r.json())
    .then(d => {
        document.getElementById("status").innerText = "Status: ✅ PROCESS DISTRUCTIO (Stopped)";
        const logArea = document.getElementById('logArea');
        const p = document.createElement('p');
